...
def promo_prompt(user_query: str, customer_name: str) -> str:
...
def general_prompt(user_query: str, customer_name: str) -> str:
...
# ================================================================
def answer_tool_func(user_query: str, orig_query: str, cust_id: str, customer_name: str = None) -> str:
    """
    Handle incoming chat queries, detect intent, and generate polite responses.
    ...
    if _match(_PATTERNS["promo"], query):
        prompt = promo_prompt(user_query, customer_name)
    else:
        prompt = general_prompt(user_query, customer_name)
